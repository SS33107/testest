...
def generate_launch_description():
    ...
    # Publish hand-eye TF
    handeye_node = Node(package = "tf2_ros", 
                       executable = "static_transform_publisher",
                       output="screen",
                       arguments = ["0.792078" , "-0.137459" , "0.614338" , "1.5808876" , "-0.1539358" , "-3.1531625" , "base" , "optical_frame_193156" ])
    # ros2 run tf2_ros static_transform_publisher 0.792078 -0.137459 0.614338 1.5808876 -0.1539358 -3.1531625  base optical_frame_193156 
    #
    # joint driver
    tm_driver_node = Node(
        package='tm_driver',
