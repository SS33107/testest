    ...
    , is_fake_(is_fake)
{
    ...
    set_velocity_srv_ = node->create_service<tm_msgs::srv::SetVelocity>(
        "set_velocity", std::bind(&TmSctRos2::set_velocity, this,
        std::placeholders::_1, std::placeholders::_2));
...
bool TmSctRos2::set_velocity(
    const std::shared_ptr<tm_msgs::srv::SetVelocity::Request> req,
    std::shared_ptr<tm_msgs::srv::SetVelocity::Response> res)

{
    bool rb = false;
    switch(req->motion_type) {
    case tm_msgs::srv::SetVelocity_Request::VEL_J:
        rb = iface_.set_vel_mode_target(VelMode::Joint, req->velocity);
        break;
    
    case tm_msgs::srv::SetVelocity_Request::VEL_T:
