...
bool BinPicking_Demo(TmDriver& TM5)
{
    ...
    /*2018.03.19 updated by YuHsien
     *ImageCpature    = {0.0479,    -0.3793,     1.5644,     0.3953,     1.5774,     0.0420}
     *ImageCpature position (XYZ) = [   0.2794972 -0.1071559  0.4511528](m)
     *ImageCpature rotation (XYZ) = [-178.8148 -0.6211 90.8207](deg)
    */
    //std::vector<double> ImageCpature    = {0.0657,    -0.6474,     2.0168,     0.2109,     1.5776,     0.0599};
    /* 2018.03.19 updated by YuHsien
     * START POSITION without Container (lower) 
     * ImageCpature {0.0657,    -0.6474,     2.0168,     0.2109,     1.5776,     0.0599};
     * ImageCpature position (XYZ) = [   0.2192082 -0.1072567  0.3544391](m)
...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        ...
        {
            double blend = 0;
            std::vector<double> vec1 = {0.0691,    -0.6283,     1.9241,     0.2848,     1.5714,     0.0632};
            TmRobot.setMoveJabs(vec1, blend);
            print_info("Back to position 1");
            std::cout << vec1[0]*180.0/3.1415926 << endl;
            std::cout << vec1[1]*180.0/3.1415926 << endl;
            std::cout << vec1[2]*180.0/3.1415926 << endl;
            std::cout << vec1[3]*180.0/3.1415926 << endl;
            std::cout << vec1[4]*180.0/3.1415926 << endl;
            std::cout << vec1[5]*180.0/3.1415926 << endl;
        }
