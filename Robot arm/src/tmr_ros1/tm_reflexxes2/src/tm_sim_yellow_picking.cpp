...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber distance_sub = nh_priv.subscribe("/eff/kinect_merge/minimum_distance",    1,distance_callback);
 ...
 //fix  above yellow box
    std::vector<double> ImageCpature = {1.5750, -0.1025, 1.3483, 0.3276, 1.5750, 0.0000};
